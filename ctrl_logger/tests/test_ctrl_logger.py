...
import ctrl.ctrl_logger.ctrl_logger
from ctrl.commands.power_on.power_on import PowerOnCommand
...
class TestCtrlLogger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ctrl.ctrl_logger.ctrl_logger.LOG_FILE = TEST_LOG
        self.log = ctrl.ctrl_logger.ctrl_logger.get_ctrl_logger()
    ...
    def test_ctrl_logger_singleton(self):
        ...
        my_log = ctrl.ctrl_logger.ctrl_logger.get_ctrl_logger()
        my_other_log = ctrl.ctrl_logger.ctrl_logger.get_ctrl_logger()
